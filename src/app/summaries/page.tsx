          ...
          <div className="max-w-4xl mx-auto space-y-8">
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                <h1 className="text-3xl font-bold tracking-tight">AI Clinical Assistant</h1>
            ...
            <Card className="border-none shadow-sm overflow-hidden">
               <CardHeader className="bg-slate-50 border-b">
                <CardTitle>Recent Insights Engine Logs</CardTitle>
                <CardDescription>Track the reasoning process of the session summarizer tool.</CardDescription>
              </CardHeader>
